# Modified GapMinder Lessons for SWC at NIST 2024

## Resources

- [NIST workshop repo](https://github.com/usnistgov/2024-06-10-nist)
- [NIST SWC webiste](https://pages.nist.gov/2024-06-10-nist)

## Nix

See the [basic Nix Python repo](https://github.com/wd15/basic-poetry2nix) for setting up the environment and adding packages.
